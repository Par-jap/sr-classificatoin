"""
MNIST Datasets class for Deep Learning of super resolusion

SRDataset:
General Class not only for MNIST.
Use to convert : (classification dataset having items [images, labels]) -> (super-resolution dataset having items [lr image, hr image, labels])

SRMNIST:
MNIST super-resolution dataset class.
It provide items [lr-letter, hr-letter, labels]
"""
